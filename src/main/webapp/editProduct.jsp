...
<div class="container">
    ...
    <form action="<%=request.getContextPath()%>/product?action=update" method="post">
        <input type="hidden" name="product_id" value="<%=p.get("product_id")%>">

        <div class="form-row">
            <label>商品编号</label>
            <input type="text" name="product_code" value="<%=p.get("product_code")%>">
        </div>
        <div class="form-row">
            <label>商品名称</label>
            <input type="text" name="product_name" value="<%=p.get("product_name")%>">
        </div>
        <div class="form-row">
            <label>分类ID</label>
            <input type="text" name="category_id" value="<%=p.get("category_id")%>">
        </div>
        <div class="form-row">
            <label>供应商ID</label>
            <input type="text" name="supplier_id" value="<%=p.get("supplier_id")%>">
        </div>
        <div class="form-row">
            <label>采购价</label>
            <input type="text" name="purchase_price" value="<%=p.get("purchase_price")%>">
        </div>
        <div class="form-row">
            <label>销售价</label>
            <input type="text" name="sale_price" value="<%=p.get("sale_price")%>">
        </div>
